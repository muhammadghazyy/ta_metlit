...
str(dfr)
xtabs(~gender + get , data=dfr)
xtabs(~job + get , data=dfr)
xtabs(~phone_dur + get , data=dfr)
xtabs(~app_dur + get , data=dfr)
xtabs(~h_w_inc + get , data=dfr)
xtabs(~education + get , data=dfr)
xtabs(~earning + get , data=dfr)

#checking confusion matrix acc per categorical var
sum(diag(xtabs(~gender + get , data=dfr))) / sum(xtabs(~gender + get , data=dfr))
sum(diag(xtabs(~job + get , data=dfr))) / sum(xtabs(~job + get , data=dfr))
sum(diag(xtabs(~phone_dur + get , data=dfr))) / sum(xtabs(~phone_dur + get , data=dfr))
sum(diag(xtabs(~app_dur + get , data=dfr))) / sum(xtabs(~h_w_inc + get , data=dfr))
sum(diag(xtabs(~h_w_inc + get , data=dfr))) / sum(table_treer)
sum(diag(xtabs(~education + get , data=dfr))) / sum(xtabs(~education + get , data=dfr))
sum(diag(xtabs(~earning + get , data=dfr))) / sum(xtabs(~earning + get , data=dfr))
